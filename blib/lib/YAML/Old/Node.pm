...
YAML::Old::Node - A generic data node that encapsulates YAML information
...
=head1 SYNOPSIS
    ...
    my $ynode = YAML::Old::Node->new({}, 'ingerson.com/fruit');
...
YAML::Old::Node is a class for generating and manipulating these containers.
...
YAML::Old::Node has a class method call new() that will return a ynode. You
pass it a regular node and an optional type tag. After that you can
use it like a normal Perl node, but when you YAML::Old::Dump it, the magical
...
YAML::Old::Node exports a function called ynode(). This function returns the tied object so that you can call special methods on it like ->keys().
...
ynodes will play a very important role in how programs use YAML::Old. They
are the foundation of how a Perl class can marshall the Loading and
Dumping of its objects.

The upcoming versions of YAML::Old will have much more information on this.
