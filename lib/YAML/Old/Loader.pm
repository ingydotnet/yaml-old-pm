...
YAML::Old::Loader - YAML::Old class for loading Perl objects to YAML

=head1 SYNOPSIS

    use YAML::Old::Loader;
    my $loader = YAML::Old::Loader->new;
    my $hash = $loader->load(<<'...');
    foo: bar
    ...
...
YAML::Old::Loader is the module that YAML::Old used to deserialize YAML to Perl
